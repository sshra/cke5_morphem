...
/**
 * The morphem (accent) command.
 *
 * @extends module:core/command~Command
 */
export default class MorphemAccentCommand extends MorphemCommand {

  /**
   * @inheritDoc
   */
  refresh() {
    // Accent is allowed only inside of 'morphem'/"morphemBase"
